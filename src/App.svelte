<script>
  ...
  setContext("PlacemarkService", new PlacemarkService("http://localhost:4000")); //import instance of class on other server
  setContext("CategoryService", new CategoryService("http://localhost:4000"));
